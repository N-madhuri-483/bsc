        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a href="mviewprofile.jsp" class="nav-link"><span data-hover="View Profile" style="color: #ffffcc;">view Profile</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="mvfeature.jsp" class="nav-link"><span data-hover="View Features" style="color: #ffffcc;">view Features</span></a>
                    </li>
                     <li class="nav-item">
...
PreparedStatement ps=con.prepareStatement("select * from feat where id='"+request.getParameter("id")+"'");
...
<form action="updateback.jsp" onsubmit="return checkcap(this);">
<h2>Updating Feature</h2>
<table>

<tr>

<td>Feature Name</td><td><input type="text" name="name" value="<%=a %>" required="required"></tr>
<tr>
<td>Description</td><td><textarea rows="6" cols="23" name="des" value="" required="required"><%=b %></textarea> </tr>
