        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a href="pviewmedlist.jsp" class="nav-link"><span data-hover="Doctor" style="color: #ffffcc;">Medical Center List </span></a>
                    </li>
                    <li class="nav-item">
...
PreparedStatement pst =con.prepareStatement("select * from medical where rests='1'");
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<tr><h3><font style="color:black"><b><u>Patient View Health Care </u></b></font></h3><br>
...
<td><a href="pview.jsp?email=<%=rs.getString(3)%>">View</a></td>
