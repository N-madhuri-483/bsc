    ...
    <div class="overlay">
      <div class="container">
        <div class="row">
          ...
          <div align="center" style="margin-left: 10%;margin-right: 10%;margin-top: 2%;border-bottom-color: aqua;" >
 <div align="center">
...
<form action="addfea1.jsp" onsubmit="return checkcap(this);">
<h2>Add Feature</h2>
<table>

<tr>

<td>Feature Name</td><td><input type="text" name="name" required="required"></tr>
<tr>
<td>Description</td><td><textarea rows="6" cols="23" name="des" required="required"></textarea> </tr>
