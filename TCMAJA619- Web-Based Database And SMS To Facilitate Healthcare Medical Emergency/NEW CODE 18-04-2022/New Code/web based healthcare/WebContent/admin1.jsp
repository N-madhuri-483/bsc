...
PreparedStatement pst =con.prepareStatement("select * from medical where rests='0'");
...
<h3><font ><b><u>New Medical Center </u></b></font></h3><br>
...
<td><a href="accept.jsp?id=<%=rs.getString("id")%>" style="font-weight: bold;color: red">Accept</a></td>
